...
>(
  (
    ...
    const buttonUtilities =
      simpleButtonVariants[variant!][colorVariant!]?.[size!];
    const iconButtons =
      icon && variantsMap[variant!][icon][colorVariant!][size!];

    const classes = icon
      ? cn(iconButtons, className)
      : cn(buttonUtilities, className);
      ...
      >
        ...
        {icon &&
          cloneElement(
            ...
            variantsMap[variant!][icon!].icon[size!]
          )}
